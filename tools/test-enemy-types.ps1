...
$info.Arguments = '/d /s /c ""' + $vcvars + '" >nul && cl /nologo /std:c++20 /EHsc /W4 /WX /utf-8 /I"' + $projectRoot + '/Game" /I"' + $projectRoot + '/externals/assimp/include" /I"' + $projectRoot + '/Game/enemy" /I"' + $projectRoot + '/Engine/math" /I"' + $projectRoot + '/externals" "' + $projectRoot + '/tests/EnemyTypesTests.cpp" "' + $projectRoot + '/Game/enemy/EnemySpawnSystem.cpp" "' + $projectRoot + '/Engine/math/Matrix4x4.cpp" /Fe:EnemyTypesTests.exe && EnemyTypesTests.exe"'
